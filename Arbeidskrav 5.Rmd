...
ggplot(aes(sets, m)) + geom_point() + geom_line() + geom_errorbar(aes(ymax = m + sd, ymin = m - sd, width = 0.2, color = "red")) + geom_line(data = styrke1, aes(sets, prosentvis.endring, group = participant), alpha = 0.9, color = "blue")
